    ...
    <form className='group space-y-6' onSubmit={handleSubmit} noValidate>
      <div>
        ...
        <input
          ...
          required
          className='peer mt-2 block w-full rounded-md border-0 px-1.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 invalid:[&:not(:placeholder-shown):not(:focus)]:ring-red-500 sm:text-sm sm:leading-6'
